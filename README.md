...
- [ ] Anime search (AniList GraphQL integration)
...
Milestones 1-6 complete (project setup, database schema, user auth, JWT login, protected routes, anime list CRUD). Currently moving into AniList API integration.
